...
import com.cheng.rrs.order.utils.ConstantPropertiesUtils;
import com.cheng.rrs.order.utils.HttpClient;
    ...
    public Map createNative(Long orderId) {
        ...
        try {
           ...
           //1 根据orderId获取订单信息
            ...
            paramMap.put("total_fee", "1");//为了测试 统一写这个只
            paramMap.put("spbill_create_ip", "127.0.0.1");
            paramMap.put("notify_url", "http://guli.shop/api/order/weixinPay/weixinNotify");
            paramMap.put("trade_type", "NATIVE");
            //4 调用微信生成二维码 ， httpClient调用
